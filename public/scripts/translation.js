const translations = {
    en: {
        ...
        'Paste a YouTube URL or upload an MP3 file.': 'Paste a YouTube URL or upload an MP3 file.',
        ...
        'Player': 'Player',
        'Grid / Beats': 'Grid / Beats',
        'Copy ChordPro': 'Copy ChordPro',
        'Current Chord': 'Current Chord',
        'Provide either YouTube URL or MP3 file.': 'Provide either YouTube URL or MP3 file.',
        'Queued analysis...': 'Queued analysis...',
        'No beat grid available.': 'No beat grid available.',
        'No active analysis to clean up.': 'No active analysis to clean up.',
        'Unable to load analyzed audio.': 'Unable to load analyzed audio.',
        'Songs': 'Songs',
        'Shares': 'Shares',
        ...
        'Share your songs and chords using a content pack file.': 'Share your songs and chords using a content pack file.',
        'Export Content Pack': 'Export Content Pack',
        'Import Content Pack': 'Import Content Pack',
        'Please select a content pack file first.': 'Please select a content pack file first.',
        'Please select at least one song.': 'Please select at least one song.',
        'Please select a destination folder.': 'Please select a destination folder.',
        'Please create at least one folder before importing songs.': 'Please create at least one folder before importing songs.',
        'No songs available.': 'No songs available.',
        'No songs found in this content pack.': 'No songs found in this content pack.',
        'Select songs to export': 'Select songs to export',
        'Download Selected Songs': 'Download Selected Songs',
        'Select songs to import': 'Select songs to import',
        'Destination folder': 'Destination folder',
        'Import Selected Songs': 'Import Selected Songs',
        'Import completed.': 'Import completed.',
        'Chords created': 'Chords created',
        'Songs created': 'Songs created',
        'Songs linked (already existed)': 'Songs linked (already existed)',
        'Songs assigned to folder': 'Songs assigned to folder',
        'Failed to import content pack.': 'Failed to import content pack.',
        'Sort by:': 'Sort by:',
        ...
        'Copied (fallback)': 'Copied (fallback)',
                    ...
                    es: {
                        ...
                        'Paste a YouTube URL or upload an MP3 file.': 'Pega una URL de YouTube o sube un archivo MP3.',
                        'YouTube URL': 'URL de YouTube',
                        'OR': 'O',
                        'Upload MP3': 'Subir MP3',
                        'Auto-detect': 'Detección automática',
                        'Analyze': 'Analizar',
                        'Cleanup Temp Files': 'Limpiar archivos temporales',
                        'Chord + Lyrics': 'Acordes + Letra',
                        'Player': 'Reproductor',
                        'Grid / Beats': 'Cuadrícula / Pulsos',
                        'Copy ChordPro': 'Copiar ChordPro',
                        'Current Chord': 'Acorde Actual',
                        'Provide either YouTube URL or MP3 file.': 'Proporciona una URL de YouTube o un archivo MP3.',
                        'Queued analysis...': 'Análisis en cola...',
                        'No beat grid available.': 'No hay cuadrícula de pulsos disponible.',
                        'No active analysis to clean up.': 'No hay análisis activo para limpiar.',
                        'Unable to load analyzed audio.': 'No se pudo cargar el audio analizado.',
                        'Songs': 'Canciones',
                        ...
                        'Share your songs and chords using a content pack file.': 'Comparte tus canciones y acordes usando un archivo de paquete de contenido.',
                        'Export Content Pack': 'Exportar Paquete de Contenido',
                        'Import Content Pack': 'Importar Paquete de Contenido',
                        'Please select a content pack file first.': 'Selecciona primero un archivo de paquete de contenido.',
                        'Please select at least one song.': 'Selecciona al menos una canción.',
                        'Please select a destination folder.': 'Selecciona una carpeta de destino.',
                        'Please create at least one folder before importing songs.': 'Crea al menos una carpeta antes de importar canciones.',
                        'No songs available.': 'No hay canciones disponibles.',
                        'No songs found in this content pack.': 'No se encontraron canciones en este paquete de contenido.',
                        'Select songs to export': 'Selecciona canciones para exportar',
                        'Download Selected Songs': 'Descargar canciones seleccionadas',
                        'Select songs to import': 'Selecciona canciones para importar',
                        'Destination folder': 'Carpeta de destino',
                        'Import Selected Songs': 'Importar canciones seleccionadas',
                        'Import completed.': 'Importaci\u00f3n completada.',
                        'Chords created': 'Acordes creados',
                        'Songs created': 'Canciones creadas',
                        'Songs linked (already existed)': 'Canciones vinculadas (ya existían)',
                        'Songs assigned to folder': 'Canciones asignadas a la carpeta',
                        'Failed to import content pack.': 'Error al importar el paquete de contenido.',
                        'Sort by:': 'Ordenar por:',
